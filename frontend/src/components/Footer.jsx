...
export default function Footer() {
  return (
    <footer class="bg-black font-sans tracking-wide">
      <div class="max-w-screen-xl mx-auto px-10 py-14 grid sm:grid-cols-2 gap-10">
        <div>
          <h4 class="text-white text-lg font-semibold mb-7">About Us</h4>
          ...
          <ul class="space-y-4 mt-5">
            <li>
              <svg
                ...
                class="inline-block w-4 h-4 fill-current text-white mr-4"
                viewBox="0 0 24 24"
              >
                <path
        ...
        <div>
          <h4 class="text-white text-lg font-semibold mb-7">Products</h4>
        ...
        <div>
          <h4 class="text-white text-lg font-semibold mb-7">Resources</h4>
          <ul class="list-none space-y-4">
            <li>
              <a
                href="javascript:void(0)"
        ...
        <div>
          <h4 class="text-white text-lg font-semibold mb-7">Subscribe</h4>
          ...
          <form>
            <div class="flex">
              <input
                type="email"
                class="px-4 py-4 text-sm rounded-l-md w-full focus:outline-none bg-gray-50"
                placeholder="Enter your email address"
              />
              <button
                type="button"
                class="bg-gray-600 hover:bg-gray-500 text-white px-4 rounded-r-md text-sm tracking-wide transition-all"
              >
                Subscribe
              </button>
            </div>
